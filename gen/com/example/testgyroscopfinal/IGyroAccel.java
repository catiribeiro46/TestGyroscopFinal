 ...
 * Original file: C:\\Users\\carla\\GoogleAppEngine\\TestGyroscopFinal\\src\\com\\example\\testgyroscopfinal\\IGyroAccel.aidl
 */
package com.example.testgyroscopfinal;
public interface IGyroAccel extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.testgyroscopfinal.IGyroAccel
{
private static final java.lang.String DESCRIPTOR = "com.example.testgyroscopfinal.IGyroAccel";
...
/**
 * Cast an IBinder object into an com.example.testgyroscopfinal.IGyroAccel interface,
 * generating a proxy if needed.
 */
public static com.example.testgyroscopfinal.IGyroAccel asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.testgyroscopfinal.IGyroAccel))) {
return ((com.example.testgyroscopfinal.IGyroAccel)iin);
}
return new com.example.testgyroscopfinal.IGyroAccel.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.testgyroscopfinal.IGyroAccel
{
